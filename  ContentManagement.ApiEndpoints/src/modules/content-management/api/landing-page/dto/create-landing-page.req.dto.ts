...
export class CreateLandingPageReqDto {
  ...
  @IsDefined() // Ensures the property is present, even if 'any' type
  ...
  @ApiPropertyOptional({
    description: 'Initial status of the landing page.',
  ...
  @IsOptional()
  @IsArray()
  // Add more specific validation if the structure of multimediaContent items is known
